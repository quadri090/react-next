            ...
            <div className='flex flex-col text-left w-[500px] text-lg font-medium p-8 text-black rounded-xl  bg-slate-300'>
                ...
                {!success && (
                    <div className='flex flex-col'>
                        <label htmlFor="email" className='text-[18px] font-semibold'>{loading ?  "Sending..." : "Enter email to reset password"}</label>
                        <input
                ...
                {success && (
                    <div>
                        <p className='text-[20px] font-semibold mt-2 text-green-500'>Password reset link has been sent to your email</p>
                        <Link href='/login'>
                            <button
                            className='p-2 h-12 text-white font-semi-bold bg-green-500 border border-gray-300 rounded-lg my-6 hover:bg-green-800'
                            > Go to Login
                            </button>
                        </Link>
                    </div>
