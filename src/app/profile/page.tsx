  ...
  return (
    ...
    <div className='min-h-screen py-2  bg-slate-900'>
      <div className='flex flex-col items-center justify-center'>
        <div  className='flex flex-col text-left w-[90%] sm:w-[500px] text-lg font-medium py-8 text-white rounded-xl'>
        ...
        <div  className='flex flex-col gap-4 text-left w-[90%] sm:w-[500px]  text-lg font-medium p-8 text-zinc-700 rounded-xl  bg-slate-300'>
          <div>
